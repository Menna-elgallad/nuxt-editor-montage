...
.container.mt-3.characters
    ...
    ClientOnly
        .row.animation(v-if="showAnimation")
            ...
            .row
              .col-lg-3.animation-icon-container(@click="[  animationName = 'fade' ,addjson(selectedJson) ]" ): img.animationIcon(src="../assets/aniamtion-icons/fade out.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'revealBottom',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/reveal 1.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'revealTop',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/reveal 2.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'revealLeft',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/reveal out.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'revealRight',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/reveal out 2.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'slideBottom',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/right slide 1.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'slideTop',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/right slide 2.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'slideRight',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/slide out 4.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'slideLeft',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/slide out.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'swear',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/smear 1.svg")
              .col-lg-3.animation-icon-container(@click="[  animationName = 'pop',addjson(selectedJson)]"): img.animationIcon(src="../assets/aniamtion-icons/zoom 4.svg")
